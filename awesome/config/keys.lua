...
keys.globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioLowerVolume", function ()
        awful.spawn.easy_async_with_shell("pulseaudio-ctl down", function(stdout)
            awesome.emit_signal("popup::volume", {amount = -5})
        end)
    end),
    awful.key({}, "XF86AudioRaiseVolume", function ()
        awful.spawn.easy_async_with_shell("pulseaudio-ctl up", function(stdout)
            awesome.emit_signal("popup::volume", {amount = 5})
        end)
    end),
    awful.key({}, "XF86AudioMute", function ()
        awful.spawn.easy_async_with_shell("pulseaudio-ctl mute", function(stdout)
